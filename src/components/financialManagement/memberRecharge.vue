<template>
  <div class="memberManagement">
    ...
    <div class="mainBox">
      ...
      <p>总汇款金额为{{this.headerForm.remittanceTotal}},其中{{this.headerForm.audited}}已审核,{{this.headerForm.unAudited}}待审核</p>
      <div class="tableBox">
        <template>
          <el-table
            :data="tableData3"
            ...
            <el-table-column align="center" prop="accountsReceivableAccount" label="收款账号"></el-table-column>
            <el-table-column align="center" prop="remittanceDate" label="汇款日期"></el-table-column>
            <el-table-column align="center" prop="remittanceInfo" label="汇款信息"></el-table-column>
            <el-table-column align="center" prop="remittanceMoney" label="汇款金额"></el-table-column>
    ...
    data() {
      ...
      return {
        ...
        tableData3: [{
          ...
          name: '张三',
          accountsReceivableAccount: '136165646513464561',
          remittanceDate: '2017-12-16',
          remittanceInfo: 'sadasda',
          remittanceMoney: 1000,
          arrivalSK: 1000,
