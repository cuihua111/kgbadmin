      ...
      <div class="tableBox">
        <template>
          <el-table
            ...
            <el-table-column align="center" prop="investmentNum" label="累计投资次数"></el-table-column>
            <el-table-column align="center" prop="investmentDate" label="投资时间"></el-table-column>
